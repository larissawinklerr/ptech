...
<div class="container mt-5">
    ...
    <form action="{{ route('app.animais.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="peso_nascimento" class="form-control @error('peso_nascimento') is-invalid @enderror"
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" name="peso_atual" class="form-control @error('peso_atual') is-invalid @enderror"

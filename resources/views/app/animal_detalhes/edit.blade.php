...
<div class="container mt-5">
    ...
    <form action="{{ route('app.animal_detalhes.update', $detalhes->animal_id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="peso_nascimento" step="0.01" class="form-control" value="{{ $detalhes->peso_nascimento }}">
        </div>

        <div class="mb-3">
            <label class="form-label">Peso atual (kg)</label>
            <input type="number" name="peso_atual" step="0.01" class="form-control" value="{{ $detalhes->peso_atual }}">
        </div>

    ...
    @foreach ($procedimentos as $procedimento)
        <div class="card shadow-sm p-3 mb-3">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <!-- Modal -->
                <div class="modal fade" id="modalExcluir{{ $procedimento->id }}" tabindex="-1" aria-labelledby="modalLabel{{ $procedimento->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Tem certeza que deseja excluir o procedimento <strong>{{ $procedimento->nome_procedimento }}</strong>?
                            </div>
